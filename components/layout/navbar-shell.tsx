            ...
            {user ? (
              <>
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 text-sm text-warm-muted hover:text-red-500 transition cursor-pointer"
                >
            ...
            {user ? (
              <div className="flex flex-col gap-3">
                ...
                <button
                  ...
                  className="text-sm text-warm-muted hover:text-red-500 px-2 py-1 text-left cursor-pointer"
                >
                  Abmelden
                </button>
              </div>
